...
const VehiclePanel = (props) => {
  return (
    <div>
        ...
        <div onClick={() => {
        ...
        }} className='flex border-2 mb-2 rounded-xl p-3 w-full items-center justify-between border-transparent active:border-black'>
          ...
          <h2 className='text-lg font-semibold'>10.21$</h2>
        </div>
        ...
        <div onClick={() => {
          ...
          <h2 className='text-lg font-semibold'>5.25$</h2>
        </div>
        ...
        <div onClick={() => {
          ...
          <h2 className='text-lg font-semibold'>3.41$</h2>
        </div>
    </div>
  )
}
